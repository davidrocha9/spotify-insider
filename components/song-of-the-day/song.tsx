...
export const Song: React.FC<SongProps> = ({ className }) => {
  return (
    <section
      className={`flex flex-col items-center justify-center flex-grow h-full ${className}`}
    >
      <Image
        isBlurred
        isZoomed
      ...
      <Card>
        ...
        <CardBody className="pb-10 pl-10 pr-10">
          <span>
            &quot;Song of the Day&quot; highlights a track that represents your
            current musical journey. Whether it&apos;s your most listened-to
            song or a recent discovery that resonates with you, this feature
            reflects your evolving taste and connection to music. Each day, we
            celebrate the tracks that define your listening habits, allowing you
            to revisit favorites and explore new sounds that have captured your
            attention. It&apos;s a personal snapshot of your musical landscape,
            showcasing what you love right now.
          </span>
        </CardBody>
      </Card>
    </section>
